...
def main():
    ...
    # Conversation History Menu
        ...
        st.image("C:/Users/bablu/Downloads/MOVIE RECOMMENDATION SYSTEM.jpg")
        ...
        """)
        st.subheader("Note")
        st.write("This chatbot is specifically built for the MOVIES RECOMMENDATION SYSTEM so it will answer questions related to MOVIES RECOMMENDATION.")
